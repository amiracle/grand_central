...
deployed_cloudformation_templates_schema = Schema({
    ...
    'custom_cloudformation_template': And(str, len, error='Invalidcustom CloudFormation template value'),
})

DEPLOYED_CLOUDFORMATION_TEMPLATES_FIELDS = ['name', 'cloudformation_stack_name', 'aws_region', 'splunk_account_link_alternate', 'cloudformation_template_link_alternate', 'grand_central_aws_account_link_alternate', 'custom_cloudformation_template']
